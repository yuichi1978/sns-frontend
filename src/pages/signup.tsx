...
const Signup = () => {
  ...
  return (
    <div
      style={{ height: "88vh" }}
      className="w-4/5 lg:w-full mx-auto flex flex-col justify-center sm:px-6 lg:px-8"
    >
      <Head>
        <title>新規作成</title>
      </Head>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-gray py-8 px-4 shadow shadow-gra-300 sm:rounded-lg sm:px-10">
